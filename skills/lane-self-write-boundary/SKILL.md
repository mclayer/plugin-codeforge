...
**Cross-cutting rule — cross-repo worktree target authority verify-before-write** (CFP-1578 / [ADR-168 §결정 1 sub-scope 1-J](../../archive/adr/ADR-168-write-time-self-write-verification-mandate.md) (구 ADR-082 Amendment 21, 재제정 CFP-2840)):
