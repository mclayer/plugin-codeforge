...
Agent model tier 정책 SSOT = [ADR-042 Amendment 9](https://github.com/mclayer/plugin-codeforge/blob/main/docs/adr/ADR-042-agent-model-selection-policy.md) (DeployPL Sonnet / DeployWorker Sonnet). rate-limit 시 Orchestrator 가 model:opus fallback spawn (ADR-057).
...
- [ADR-042 Amendment 9](https://github.com/mclayer/plugin-codeforge/blob/main/docs/adr/ADR-042-agent-model-selection-policy.md) — DeployPL/Worker Sonnet tier
