...
3. 세 결과 수령 후 **합성 순서** 준수 (ADR-161 §결정 3)
   ...
   (c) §6 Researcher — 외부 개념으로 용어 disambiguation
       ...
       · §6 Section 6 (Concept Summary) compact summary 활용 = concept 파일 직접 Glob 부담 제거용 single-read-surface 보조 (ADR-161 §결정 4 무손상). **§6 가 하류 *기술수요*를 충당한다는 기대 금지** — 그 수요는 ADR-125 단계③(S2)/on-demand(S5)가 담당.
