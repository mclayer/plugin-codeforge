...
(PLAgent가 concept 파일을 직접 Glob+Read하지 않고 §6에서 합성 가능하도록 충분한 요약 제공 = single-read-surface 보조 역할, ADR-056 §결정 4. **하류 기술수요 충당 기대 대상 아님** — 그 수요는 ADR-125 단계③ S2 / on-demand S5 가 담당.)
