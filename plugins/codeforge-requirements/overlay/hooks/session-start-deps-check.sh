#!/usr/bin/env bash
# codeforge-requirements SessionStart dependency check
#
...
✗ codeforge-requirements plugin 의존성 누락
...
자세한 사항: https://github.com/mclayer/plugin-codeforge/tree/main/plugins/codeforge-requirements#dependencies
