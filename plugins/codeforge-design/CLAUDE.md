...
| RefactorAgent (4-tuple sub-tuple) | 설계 lane 진입 즉시 | §3 도입할 설계 (refactor 시각 — decoupling / reusability / pattern / interface 분리) + §6 (중복제거·공통추출·repo-분해 advocacy, escalation-tier — 경계 확정은 ModuleArch authority) |
