#!/usr/bin/env bash
# codeforge-design SessionStart dependency check
#
...
✗ codeforge-design plugin 의존성 누락
...
자세한 사항: https://github.com/mclayer/plugin-codeforge/tree/main/plugins/codeforge-design#dependencies
