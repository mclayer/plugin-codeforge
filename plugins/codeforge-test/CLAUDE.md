...
> **[REVIVED — CFP-367 / ADR-055 (2026-05-10) · Epic-level 전환 — CFP-371 / ADR-055 Amendment 2]** 통합테스트 전용 lane으로 부활. IntegrationTestAgent(fable — ADR-141 Amendment 4 carve-out) 신규 추가. TestAgent / StatefulTestAgent는 deprecated 유지(ADR-048 §결정 2).
