#!/usr/bin/env bash
# codeforge-test SessionStart dependency check
#
...
자세한 사항: https://github.com/mclayer/plugin-codeforge/tree/main/plugins/codeforge-test#dependencies
