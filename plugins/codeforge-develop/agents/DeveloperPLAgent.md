...
**테이블 포맷·GitHub sub-issue 규격은 [`templates/impl-manifest.md`](https://github.com/mclayer/plugin-codeforge/blob/main/templates/impl-manifest.md) SSOT 참조**.
...
- 참조 절차: [`docs/orchestrator-playbook.md`](https://github.com/mclayer/plugin-codeforge/blob/main/docs/orchestrator-playbook.md) §6.6 SSOT
