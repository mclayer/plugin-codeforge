...
요약: kind:contract 7 entry (review_verdict·requirements_output·design_output·develop_output·test_verdict·pmo_output·git_ops_event). kind:registry 6 entry (label-registry / debate-protocol / evidence-check-registry / severity-propagation / parallel-dispatch-protocol-v1 + comment-prefix·fix-event chain). Versioning SSOT = [ADR-008](docs/adr/ADR-008-inter-plugin-contract-versioning.md). sibling sync SSOT = [ADR-010](docs/adr/ADR-010-inter-plugin-contract-sibling-sync.md). kind:registry = sibling sync 면제. review-verdict-v4 현재 버전 = **v4.5** (CFP-597 / ADR-063 Amendment 1 — `marketplace_sync_declared`. CFP-609 신규 entry = `parallel-dispatch-protocol-v1` ADR-064 Amendment 1). label-registry-v2 현재 = **v2.21** (CFP-795 — 신규 `fast-pass` category).
