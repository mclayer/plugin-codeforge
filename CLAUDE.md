...
**필수 플러그인 (5종)**:
- `codeforge-review@mclayer` — review subsystem (3 PL + 2 worker + base + 3 checklist). codeforge core 와 양방향 review_verdict v1 contract 로 통신. CFP-29 Phase 1 추출 (BREAKING v0.17.0). 미설치 시 설계 리뷰·구현 리뷰·보안 테스트 lane 진행 불가
