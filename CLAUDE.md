...
## ProductionEvidenceDeputy 이관 (ADR-088 §결정 4 / ADR-072 Amendment N)
...
- [ADR-072](https://github.com/mclayer/plugin-codeforge/blob/main/docs/adr/ADR-72-production-evidence-deputy-and-epic-cutover-gate.md) — ProductionEvidenceDeputy mandate (이관 후 본 lane deputy)
