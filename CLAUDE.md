...
| 매 user-facing turn 직전 (사용자 dialog turn) | `codeforge:user-dialog-mode` | frame mode 4 step + 4 layer + sub-mechanism 2 종 lookup ([ADR-071](docs/adr/ADR-071-orchestrator-user-dialog-convergence.md) / CFP-612) |
