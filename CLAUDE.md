...
요약: kind:contract 7 entry (review_verdict·requirements_output·design_output·develop_output·test_verdict·pmo_output·git_ops_event). kind:registry 7 entry (label-registry / debate-protocol / evidence-check-registry / severity-propagation / parallel-dispatch-protocol-v1 / **defense-in-depth-sublayer-registry-v1 (CFP-709 / ADR-075)** + comment-prefix·fix-event chain). Versioning SSOT = [ADR-008](docs/adr/ADR-008-inter-plugin-contract-versioning.md). sibling sync SSOT = [ADR-010](docs/adr/ADR-010-inter-plugin-contract-sibling-sync.md). kind:registry = sibling sync 면제. review-verdict-v4 현재 버전 = **v4.5** (CFP-597 / ADR-063 Amendment 1 — `marketplace_sync_declared`. CFP-609 신규 entry = `parallel-dispatch-protocol-v1` ADR-064 Amendment 1. CFP-709 신규 entry = `defense-in-depth-sublayer-registry-v1` ADR-075 — defense-in-depth sublayer enumeration SSOT 분리).
