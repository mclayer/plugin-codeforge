...
- [evidence-check-registry-v1.md](docs/inter-plugin-contracts/evidence-check-registry-v1.md) — evidence-enforceable governance check schema (CFP-389 / ADR-060). registry data SSOT = [`docs/evidence-checks-registry.yaml`](docs/evidence-checks-registry.yaml). MANIFEST `registries:` entry = `evidence_check_registry`.
