...
- **묻는 경우는 ask-trigger 3종뿐** (ADR-071 §결정 5 redirect): ① 사용자 요구 자체가 애매 ② 확실히 짚어야 하는 진짜 가치 trade-off(default 비자명) ③ 비가역·고비용(중대 결함/대거 삭제/rollback/외부 발송). 그 외 모호 포함 전부 무조건 진행 — "안전하니 일단 물어" 금지.
