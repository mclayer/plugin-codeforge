...
## Pre-Issue scenario (Stage 0 — [ADR-034](../../archive/adr/ADR-034-pre-issue-brainstorming-stage.md))
...
- **Plugin repo dogfood (codeforge family)**: spec path = `<internal-docs-clone>/<plugin-folder>/specs/YYYY-MM-DD-cfp-NNN-<slug>-design.md` ([ADR-013](../../archive/adr/ADR-013-codeforge-family-dogfood-out-policy.md) / [ADR-017](../../archive/adr/ADR-017-skill-override-path-enforcement.md) enforced — default path PROHIBITED)
