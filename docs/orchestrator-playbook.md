...
### 3.1 6 레인 + Cross-cutting 스폰 순서 (요약)
...
| **DomainAgent** | 사용자 원문 verbatim (Story 페이지 §1 복사) + 4소스 fetch 경로 (Confluence Domain Knowledge CQL, ADR Trading Strategy, src/mctrader/domain/**, §1 원문) |
...
```
write queue 파일: /tmp/mctrader-doc-queue/<epic>/<seq>-adr-draft.md
