...
### 1n. Deploy lane + Deploy Review lane (CFP-1059 / [ADR-087](../archive/adr/ADR-087-deploy-lane-and-lifecycle-extension.md) + [ADR-088](../archive/adr/ADR-088-deploy-review-lane-and-production-evidence-transfer.md))
...
#### Schema 변경 7 원칙 (CFP-1059 / [ADR-089](../archive/adr/ADR-089-schema-change-7-principles.md))
