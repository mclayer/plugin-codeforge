...
## 7.0.6 Telemetry opt-in (CFP-283 / ADR-042 / ADR-043)

**Phase 1 wrapper-only doc + schema land** — measurement channel 도입 (stop-event-v1 ledger schema 신설). 모든 telemetry channel = **opt-in default false** invariant.
