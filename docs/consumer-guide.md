...
### 3a. `.claude/_overlay/CLAUDE.md` 예시
...
- Confluence space: `<SPACE_KEY>` (spaceId=<SPACE_ID>)
- Story parent pageId: <STORIES_PARENT_ID>
- Story template pageId: <STORY_TEMPLATE_ID>
- Jira project key: `<PROJECT_KEY>`
- Atlassian host: `https://<your-org>.atlassian.net`

## Domain Knowledge

- [<도메인 지식 루트 페이지>](https://<your-org>.atlassian.net/wiki/spaces/<SPACE_KEY>/pages/<PAGE_ID>)
...
- `component:<A>`, `component:<B>`, `component:<C>` (프로젝트 컴포넌트)
```
...
### 3c. `.claude/_overlay/agents/<Name>.md` 예시
