...
### Phase 2 후속 분리 (실제 적용 결과)

CFP-17 머지 직후 sprint retro §2.3 권고에 따라 후속 분리. 일부는 **사용자 critical feedback / brainstorming으로 CFP 번호 repurpose**되어 실제 매핑이 아래와 같이 변경됨:

| Codex# | 권고 시점 (sprint retro) | 실제 적용 CFP | 변경 사유 |
|--------|------------------------|--------------|----------|
| #1 TestContractArchitect | CFP-18 | **CFP-18** ✅ | 권고대로 |
| #2 DataMigrationArchitect | CFP-19 (deferred) | **CFP-21** (v0.14.0 BREAKING) | CFP-19는 사용자 "전체적으로 너무 느리다" feedback으로 R1-R11 병렬화로 repurpose |
| #4·#5·#6 관측성·API·SLO | CFP-20 묶음 | **CFP-22** (v0.14.1) | CFP-20은 brainstorming session에서 Live Progress dashboard로 repurpose |

**Codex audit 7건 전건 closure 검증**: [`docs/retros/2026-04-28-codex-audit-closure-sprint.md`](../retros/2026-04-28-codex-audit-closure-sprint.md) §2.1.

Phase 2 종합:
- CFP-18 (Codex #1) → ADR-006
- CFP-21 (Codex #2) → ADR-007
- CFP-22 (Codex #4·#5·#6) → design.md checklist (별도 ADR 없음)
- CFP-17 (Codex #3·#7) → ADR-004 본문
