...
- [ADR-033](../../../../archive/adr/ADR-033-docker-first-infra-engineering.md) — Docker-first Infra. R-3 의 "Docker rust-image 마운트 빌드" 표준 경로가 이 정책과 정합 (Docker primary).
...
- Story CFP-2506 (internal-docs `wrapper/stories/CFP-2506.md`) — 본 KB 도출 Story.
