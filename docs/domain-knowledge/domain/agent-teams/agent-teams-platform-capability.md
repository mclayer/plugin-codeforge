...
| Parallelization | TEAM-DESIGN 7+3+1 deputy roster (7 permanent + 3 CONDITIONAL + 4-tuple sub-tuple — CFP-1086 Amendment 8) / 2 review worker 동시 | §14 Lane Evidence `spawned_at` diff |
