...
본 protocol carrier ADR = [ADR-059](../adr/ADR-059-debate-protocol-v1.md).
...
- **Section schema**: trigger / rounds / termination 3 block — 본 registry §"Trigger / Round / Termination schema" 정합
...
## Anchor 재발 escalation (ADR-059 §결정 4 SSOT)
...
## AskUserQuestion escalation (max 5 미합의 시)
