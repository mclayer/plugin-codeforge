...
status: Deprecated  # ADR-121 (CFP-2225) — lane 폐지, sunset 2026-07-13 KST. 물리 삭제 = Epic #2217 S5. 구 주석 (Phase 1 placeholder declare only, CFP-1059/ADR-088) 이력 + canonical_repo 행 pre-existing drift 기록 = 보존.
