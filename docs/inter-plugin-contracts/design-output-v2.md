...
본 sibling 은 [`mclayer/plugin-codeforge-design`](https://github.com/mclayer/plugin-codeforge-design/blob/main/docs/inter-plugin-contracts/design-output-v2.md) canonical 의 verbatim mirror.

- canonical 변경 시 본 sibling sync PR 후속 의무 (ADR-010)
- 본 sibling 은 Read-only 참조용. 변경은 canonical 에서만 수행
- 본 sync PR-F (CFP-46) 가 v2 sibling 신설
