...
- **[ADR-033 — Docker-first infra engineering](https://github.com/mclayer/plugin-codeforge/blob/main/docs/adr/ADR-033-docker-first-infra-engineering.md)** (CFP-128) — ADR-014 amend by. OpRiskArch §7.4 mandate 에 §7.4.6 Container considerations 추가. 신규 deputy 미도입 — additive minor in-place bump.
