...
**v2.24 (CFP-820 / ADR-063 Amendment 5 §결정 16, 2026-05-17)**: PATCH bump (schema 무변경 — §3 yaml hotfix-bypass:* 33번째 family member append).
...
- ADR-008 §결정 3 SSOT: 신규 label entry 1 append = PATCH bump.
