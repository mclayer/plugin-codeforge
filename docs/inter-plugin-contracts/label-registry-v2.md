...
date: 2026-05-24  # CFP-1421 v2.56 — issue-design-content-confluence-link lint bypass channel 신설 (1 신규 entry: hotfix-bypass:issue-design-content-confluence-link 79번째 hotfix-bypass:* family member, CFP-1421 / ADR-111 §결정 5 cross-link discipline mechanical wire carrier — Sub-A S1.3 of Mega-Epic CFP-1415, Issue body / PR body design doc 4 mirror 대상 참조 시 Confluence anchor link 동반 grep-presence 검증 workflow bypass channel, evidence-checks-registry issue-design-content-confluence-link entry 의 bypass channel, warning-tier). MINOR bump: 1 신규 entry, kind:registry sibling sync 면제 (ADR-010 §결정 2 + ADR-008 §결정 3 row append), plugin.json bump 0 = marketplace_sync_declared: false (mirrored field 변경 0). MANIFEST.yaml row "2.55" → "2.56" ratchet 동반. ADR-024 Amendment N §결정 6.A per-entry namespace 정합 carrier. META self-application 3rd applied case = 본 Story Phase 1 PR raw active 78 + new 1 = 79 정합 (CFP-1346 META self-app 1st + CFP-1384 META self-app 2nd 후 답습, ADR-108 §결정 6 dogfood loop close 정합).
...
- date: 2026-05-17
  ...
  # CFP-1421 신설 — 1 entry (hotfix-bypass:issue-design-content-confluence-link), ADR-111 §결정 5 mechanical wire carrier (Sub-A S1.3 of Mega-Epic CFP-1415)
  - name: hotfix-bypass:issue-design-content-confluence-link
    category: hotfix-bypass
    color: "fef2c0"
    description: "hotfix-bypass: issue-design-content-confluence-link warning-tier mechanical lint 조건부 skip + audit comment 자동 발의 (CFP-1421 / ADR-111 §결정 5 cross-link discipline carrier — Issue body / PR body 안 design doc 4 mirror 대상 (ADR / Living Architecture / Change Plan / Domain Knowledge) 참조 시 Confluence anchor link 동반 grep-presence 검증 workflow bypass channel, evidence-checks-registry issue-design-content-confluence-link entry 의 bypass channel). Sub-A 마지막 mechanical activation Story (Sub-A S1.3 of Mega-Epic CFP-1415 Confluence-as-derived-mirror governance standardization). Detection regex: design content (?:ADR-\\d+|docs/architecture|docs/change-plans|docs/domain-knowledge) + Confluence link mclayer.atlassian.net|atlassian.net/wiki. **79번째 hotfix-bypass:* family member (ADR-108 forcing function parity mandate — description text N번째 명시 의무, META self-application 3rd applied case = CFP-1346 1st + CFP-1384 2nd 후 답습, Phase 1 PR commit 시점 raw active 78 + new 1 = 79 정합)**."
    single_active: false
    attach_owner_plugin: "Orchestrator (CFP-1421 issue-design-content-confluence-link warning-tier bypass — consumer 환경 임시 skip 시 부착) / ArchitectAgent"
