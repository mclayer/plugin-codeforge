...
- **#1 = CFP-18 + ADR-006으로 해소**: TestContractArchitectAgent (5번째 deputy, §8 Test Contract author input) 신설. 상세는 [ADR-006](ADR-006-test-contract-architect-deputy.md) 및 [CFP-18](../stories/CFP-18.md) 참조.
