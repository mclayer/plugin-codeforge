...
related_adrs:
  ...
  - ADR-072      # 배경 — ProductionEvidenceDeputy + production cutover incident response 영역 (rollback-protocol.md 의 owner SubAgent — Step 6 4-evidence-quad re-verify 정합)
...
- **ADR-072** — ProductionEvidenceDeputy + production cutover (rollback-protocol owner SubAgent)
