...
본 ADR scope = visibility expansion 만. Stop policy SSOT = **ADR-022 + ADR-025 + Amendment 1 (CFP-73 / CFP-80) 그대로 유지**:

- 5 whitelist (ADR-022 §결정 2): (1) user environment 변경 의무, (2) destructive action 직전, (3) 진정 unprecedented, (4) decider escalation_required=true, (5) 작업 단위 완료 후 final report
