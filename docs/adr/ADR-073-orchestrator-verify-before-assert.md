...
| evidence-check-registry-v1 v1.2 → v1.3 MINOR mirror (entry count + table row, kind:registry sibling sync 면제 ADR-010 §결정 3) | 본 Amendment 9 | Phase 1 |
