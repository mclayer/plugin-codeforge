...
- **Atomicity boundary — 의미 invariant vs runtime implementation 분리** (FIX iter 1 / Codex TP#2 F-001 re-frame, 2026-05-15 KST):
  ...
  - **runtime future (Wave 2 Story-4 ratchet)**: `family_7_plugin` runtime carrier (`scripts/atomic-upgrade-7-plugins.sh` 신설 시점) — 의미 invariant 와 runtime 일치점. 본 시점 reconcile-protocol-v1.md MINOR bump (v1.0 → v1.1) 의무.
