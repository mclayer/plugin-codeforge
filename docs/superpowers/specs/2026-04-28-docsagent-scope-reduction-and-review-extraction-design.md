...
- [`agents/ArchitectAgent.md`](../../../agents/ArchitectAgent.md) · [`agents/DomainAgent.md`](https://github.com/mclayer/plugin-codeforge-requirements/blob/main/agents/DomainAgent.md) · [`agents/PMOAgent.md`](https://github.com/mclayer/plugin-codeforge-pmo/blob/main/agents/PMOAgent.md) — 권한 추가 대상
