...
- [`agents/DocsAgent.md`](https://github.com/mclayer/plugin-codeforge/blob/v3.0.0/agents/DocsAgent.md) — scope 축소 대상
- [`agents/ArchitectAgent.md`](https://github.com/mclayer/plugin-codeforge-design/blob/main/agents/ArchitectAgent.md) · [`agents/DomainAgent.md`](https://github.com/mclayer/plugin-codeforge-requirements/blob/main/agents/DomainAgent.md) · [`agents/PMOAgent.md`](https://github.com/mclayer/plugin-codeforge-pmo/blob/main/agents/PMOAgent.md) — 권한 추가 대상
