...
**파일**: [agents/DeveloperPLAgent.md](https://github.com/mclayer/plugin-codeforge-develop/blob/main/agents/DeveloperPLAgent.md), [agents/ArchitectPLAgent.md](../../../agents/ArchitectPLAgent.md), [docs/orchestrator-playbook.md](../../orchestrator-playbook.md) §FIX state machine.
...
**파일**: [agents/DocsAgent.md](../../../agents/DocsAgent.md) §9 Impl Manifest helper, [agents/DeveloperPLAgent.md](https://github.com/mclayer/plugin-codeforge-develop/blob/main/agents/DeveloperPLAgent.md) (수동 작성 deprecated).
...
**파일**: `codeforge-review:agents/SecurityTestPLAgent.md`, [agents/DocsAgent.md](../../../agents/DocsAgent.md) §Bash 권한 (security prefetch helper).
