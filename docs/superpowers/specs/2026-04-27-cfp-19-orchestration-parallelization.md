...
**파일**: [agents/DocsAgent.md](https://github.com/mclayer/plugin-codeforge/blob/v3.0.0/agents/DocsAgent.md) §write queue 형식 + [docs/orchestrator-playbook.md](../../orchestrator-playbook.md) §11 + DocsAgent 의뢰자 18종 md (mode 라벨 명시 의무).
...
**파일**: `codeforge-review:templates/review-pl-base.md` §3 (verdict-first protocol) + 3 ReviewPL md (DesignReview/CodeReview/SecurityTest).
...
**파일**: [agents/DeveloperPLAgent.md](https://github.com/mclayer/plugin-codeforge-develop/blob/main/agents/DeveloperPLAgent.md), [agents/ArchitectPLAgent.md](https://github.com/mclayer/plugin-codeforge-design/blob/main/agents/ArchitectPLAgent.md), [docs/orchestrator-playbook.md](../../orchestrator-playbook.md) §FIX state machine.
...
**파일**: [agents/DocsAgent.md](https://github.com/mclayer/plugin-codeforge/blob/v3.0.0/agents/DocsAgent.md) §9 Impl Manifest helper, [agents/DeveloperPLAgent.md](https://github.com/mclayer/plugin-codeforge-develop/blob/main/agents/DeveloperPLAgent.md) (수동 작성 deprecated).
...
**파일**: [agents/ArchitectPLAgent.md](https://github.com/mclayer/plugin-codeforge-design/blob/main/agents/ArchitectPLAgent.md) §메타-규칙 (pre-synthesis fast path 추가).
...
**파일**: `codeforge-review:agents/SecurityTestPLAgent.md`, [agents/DocsAgent.md](https://github.com/mclayer/plugin-codeforge/blob/v3.0.0/agents/DocsAgent.md) §Bash 권한 (security prefetch helper).
...
**파일**: `codeforge-review:templates/review-pl-base.md` §3, [docs/orchestrator-playbook.md](../../orchestrator-playbook.md) §FIX state machine, [agents/DeveloperPLAgent.md](https://github.com/mclayer/plugin-codeforge-develop/blob/main/agents/DeveloperPLAgent.md).
...
- `codeforge-review:templates/review-pl-base.md` — verdict-first protocol (R2·R11)
- [agents/DocsAgent.md](https://github.com/mclayer/plugin-codeforge/blob/v3.0.0/agents/DocsAgent.md) — dual-mode queue (R1) + impl-manifest helper (R5) + security-prefetch helper (R10)
- `codeforge-review:agents/DesignReviewPLAgent.md` — Orchestrator-direct spawn (R3) + verdict-first (R2)
- `codeforge-review:agents/CodeReviewPLAgent.md` — same as above
- `codeforge-review:agents/SecurityTestPLAgent.md` — same + R10 cache 첨부
- [agents/ArchitectPLAgent.md](https://github.com/mclayer/plugin-codeforge-design/blob/main/agents/ArchitectPLAgent.md) — fail-fast pre-synthesis (R8) + parallel diagnosis (R4)
- [agents/DeveloperPLAgent.md](https://github.com/mclayer/plugin-codeforge-develop/blob/main/agents/DeveloperPLAgent.md) — parallel diagnosis (R4) + manifest review (R5) + fast-path (R11)
