...
- Phase 1 = 본 ADR + Change Plan §3.6 + family.md interfaces/data_flow 반영. Phase 2 = 계약 파일 + MANIFEST row + **10-agent 대상 / 주입 파일 7** (agent .md 6 [요구 4 + Mapper + ArchitectAnalyst] + review-pl-base 1) 배선 (Change Plan §5 #13-21).
