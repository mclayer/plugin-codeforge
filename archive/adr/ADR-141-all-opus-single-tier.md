...
- **Claude Code floor**: fable floor(v2.1.170)를 폐기하고 **Opus 4.8 인식 최소 버전 = v2.1.154** 로 갱신한다 (source: 요구사항리뷰 lane — Opus 4.8 alias 인식 최소 CLI 버전). consumer-guide "필수 의존성" 갱신 (Phase 2).
...
- architecture doc 1 (codeforge-family.md tier 서술 갱신).
