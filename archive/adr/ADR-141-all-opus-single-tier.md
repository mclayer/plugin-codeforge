...
Change Plan 면제(ADR-013 정합 — 본 Amendment + ADR-109 §결정 1 Amendment 1 이 설계 SSOT). 실 배선 = 별도 Phase 2 PR:
...
- ADR-141 Amendment 4 — A4-1(fable 10 roster = failover 대상 집합) / A4-3(guard — AC-9 무손상) / A4-6 L595(fable 429 dead-mark — byte 보존 + fable-리밋 한정 override)
