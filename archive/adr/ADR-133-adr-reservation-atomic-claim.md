...
- **stale reclaim = abandoned 마커 + 번호 재사용 금지 + gap 허용**(단조성 보존, ABA-safe. `source:` Herlihy & Wing "Linearizability" ACM TOCS 1990 §5). slot-level 신규 cron(Issue-level `reservation-cleanup.yml` 과 별개).
