...
3. **상류 openai/codex Windows 인코딩 결함** — open = #4013 단독 (Cannot force UTF-8) + 종결 3건 (#7290/#4498/#4574) 은 반복·회귀 패턴 이력 근거. 4건 전부 출력·콘솔 축 실측 — 입력 promptfile 오디코딩의 직접 증거는 부재, 입력측 리스크 = 동종 class 추정 [hypothesis]. **"완전 차단" 단정 금지.**
