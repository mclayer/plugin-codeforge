...
- warning tier 첫 도입 (ADR-060 §결정 5 정합 — 모든 신규 entry 는 warning 시작 강제). 본 entry = ADR-072 §결정 5 `production-cutover-deputy-spawn-evidence` + `epic-cutover-gate-evidence-quad-check` 2 entry warning-tier 동반. blocking-on-pr 격상 = empirical evidence 누적 후 별 CFP carrier 영역 (ADR-060 승격 gate AND condition 통과 의무).
