...
- **ADR-146/150 Amendment 로 착륙**: activation oracle = 새 mechanism + 신규 게이트/좌표/cross-field 검사 + G3(b) Epic-close 축 → 별도 컨텍스트/결정/결과 블록 필요 → 기각, 신규 ADR-152(§결정 1, A2-5 구조).
