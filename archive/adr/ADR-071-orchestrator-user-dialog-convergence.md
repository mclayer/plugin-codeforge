...
- 3 file 동시 반영: 본 ADR (§결정 5 redirect 1줄 + 본 §결정 20 신설) + [skills/user-dialog-mode/SKILL.md](../../skills/user-dialog-mode/SKILL.md) §결정 5 결정 트리·touchpoint (a) scope 칸 + [CLAUDE.md](../../CLAUDE.md) "## 결정 · 대화 원칙" bullet 1개.
