"""test_dev_process_ship_time_parity.py — SHIP-TIME 20-field parity (lead mandate, FIRST-CLASS).
...
즉 "declared 20 == captured 20 == contract §2 count". doc vs code born-drift = FAIL
