# CFP-478 fixture: check-doc-section-schema

## Description
Story section schema validation
...
1. `scripts/check-doc-section-schema.sh` thin wrapper exists and references `scripts/lib/` SSOT
