# CFP-478 fixture: test-check-inter-plugin-drift

## Description
Inter-plugin contract drift baseline
...
1. `scripts/test-check-inter-plugin-drift.sh` thin wrapper exists and references `scripts/lib/` SSOT
