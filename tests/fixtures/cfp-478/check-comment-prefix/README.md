# CFP-478 fixture: check-comment-prefix

## Description
Comment prefix registry validation
...
1. `scripts/check-comment-prefix.sh` thin wrapper exists and references `scripts/lib/` SSOT
