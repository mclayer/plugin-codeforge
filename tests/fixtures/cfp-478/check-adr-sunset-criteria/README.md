# CFP-478 fixture: check-adr-sunset-criteria

## Description
ADR sunset criteria mandate
...
1. `scripts/check-adr-sunset-criteria.sh` thin wrapper exists and references `scripts/lib/` SSOT
