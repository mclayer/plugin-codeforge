# CFP-478 fixture: check-label-registry

## Description
Label registry bootstrap sync
...
1. `scripts/check-label-registry.sh` thin wrapper exists and references `scripts/lib/` SSOT
