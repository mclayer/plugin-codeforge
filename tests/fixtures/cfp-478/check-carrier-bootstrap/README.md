# CFP-478 fixture: check-carrier-bootstrap

## Description
Carrier bootstrap frontmatter
...
1. `scripts/check-carrier-bootstrap.sh` thin wrapper exists and references `scripts/lib/` SSOT
