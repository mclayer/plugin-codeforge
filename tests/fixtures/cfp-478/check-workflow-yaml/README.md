# CFP-478 fixture: check-workflow-yaml

## Description
GitHub workflow YAML pattern check
...
1. `scripts/check-workflow-yaml.sh` thin wrapper exists and references `scripts/lib/` SSOT
