# CFP-478 fixture: check-story-section-schema

## Description
Story section structure validation
...
1. `scripts/check-story-section-schema.sh` thin wrapper exists and references `scripts/lib/` SSOT
