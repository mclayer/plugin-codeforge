# CFP-478 fixture: sync-required-workflows

## Description
Required workflow spec parse (bash hybrid)
...
1. `scripts/sync-required-workflows.sh` thin wrapper exists and references `scripts/lib/` SSOT
