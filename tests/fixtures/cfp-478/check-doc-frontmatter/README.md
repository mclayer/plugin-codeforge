# CFP-478 fixture: check-doc-frontmatter

## Description
Doc frontmatter required fields
...
1. `scripts/check-doc-frontmatter.sh` thin wrapper exists and references `scripts/lib/` SSOT
