# CFP-478 fixture: check-inter-plugin-contracts

## Description
Inter-plugin contract MANIFEST check
...
1. `scripts/check-inter-plugin-contracts.sh` thin wrapper exists and references `scripts/lib/` SSOT
