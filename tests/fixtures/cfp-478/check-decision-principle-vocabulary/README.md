# CFP-478 fixture: check-decision-principle-vocabulary

## Description
Decision principle vocab lint
...
1. `scripts/check-decision-principle-vocabulary.sh` thin wrapper exists and references `scripts/lib/` SSOT
