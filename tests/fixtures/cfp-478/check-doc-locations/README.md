# CFP-478 fixture: check-doc-locations

## Description
Doc location registry freshness check
...
1. `scripts/check-doc-locations.sh` thin wrapper exists and references `scripts/lib/` SSOT
