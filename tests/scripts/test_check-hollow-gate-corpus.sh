...
HGC_EXPECTED_CASE_TOTAL=77   # = 실 케이스 65 + §13.5 구성 앵커 2 + §13.6 T-SIG 6 + §13.7 T-FALS 3
                             #   + 본 pin 케이스 자신 1
...
HGC_DECLARED_COMPOSITION="census=91/47/1 helper=9f1950b3fd0e loopdecl=d2663b9e38cf"
