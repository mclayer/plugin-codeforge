...
MANIFEST = [
    ...
    {"name": "fix-ledger-sync.yml", "event_class": "M", "side_effect_class": "B", "cancel_spec": "false", "group_shape": "B", "is_d": False, "is_narrow": False, "in_tpl": True, "in_gh": False, "shared": False, "wired": True},
    ...
    {"name": "phase-label-invariant.yml", "event_class": "P", "side_effect_class": "B", "cancel_spec": "false", "group_shape": "B", "is_d": False, "is_narrow": False, "in_tpl": True, "in_gh": True, "shared": True, "wired": True},
