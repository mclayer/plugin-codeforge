...
## [5.45.0] - 2026-05-14 — CFP-610 Story 2 Phase 2 FIX iter 1 (ADR-064 Amendment 2 mechanical enforcement + marketplace atomic sync)
...
- mclayer/marketplace: plugins[codeforge].version 5.44.0 → 5.45.0 mirrored (ADR-063 atomic invariant)
