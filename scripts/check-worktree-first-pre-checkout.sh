...
# worktree-first pre-checkout hook check — Story 1 skeleton (warning tier)
#
...
echo "[worktree-first-pre-checkout] SKELETON (Story 3 CFP-428 wires actual git hook)"
echo "  - scope: main working tree 에서 git checkout cfp-NNN 차단 (worktree-first 정책 정합)"
