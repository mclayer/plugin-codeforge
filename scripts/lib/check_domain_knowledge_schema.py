...
#
# Usage:
#   python3 scripts/lib/check_domain_knowledge_schema.py
#   python3 scripts/lib/check_domain_knowledge_schema.py --files <path1> <path2> ...  (subset check)
import sys, io
import sys
...
def check_fm_field(fm_lines: list, field: str):
