...
Epic-level lane spawn 1회 within N Story measurement. 결과 path = `tests/integration/stories/<EPIC-KEY>/<STORY-KEY>/` (self-write 표 already-codified) — §7.4 측정 evidence 영역 row append 는 Wave 2 별 sub-CFP scope.
