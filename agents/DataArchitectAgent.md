...
**빅데이터 OLAP 영역 변호자**. ArchitectPLAgent 직속 SubAgent. CFP-1086 / ADR-042-agent-model-selection-policy Amendment 8 — mandate 축소 (RDB OLTP 영역 제거 → 빅데이터 OLAP only).
...
이전 mandate (CFP-1026 W2 S3, ADR-042-agent-model-selection-policy Amendment 7) 의 다음 항목 = CFP-1086 Amendment 8 에서 **ModuleArch (aggregate-level) primary** 로 이동:
